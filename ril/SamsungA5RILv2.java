 ...
 * {@hide}
 */
public class SamsungA5RILv2 extends RIL {
    ...
    public SamsungA5RILv2 (Context context, int preferredNetworkType, int cdmaSubscription) {
        this(context, preferredNetworkType, cdmaSubscription, null);
    }

    public SamsungA5RILv2 (Context context, int preferredNetworkType,
